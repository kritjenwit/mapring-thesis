...
import { NatureInputGroup } from "../../../../components/NatureInputGroup";
  ...
  return (
    <SSRProvider>
      <Layout isFluid>
        ...
        >
          <Col lg={12}>
            <h1>ด้านวิชาการ (ลักษณะอันพึงประสงค์)</h1>
                              ...
                              <Table responsive bordered striped size="sm">
                                <thead>
                                  <tr>
                                    ...
                                    {config.dropdown.manners &&
                                    config.dropdown.manners.length > 0
                                      ? config.dropdown.manners.map(
                                          (manner: any) => (
                                            <th
                                              style={style}
                                              // @ts-ignore
